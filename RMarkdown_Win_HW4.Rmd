...
###**E. Conclusion**
#####I still insist my opinion that we should use logistic regression in this case. If the bank really wants to pursue high accuracy, then random forest model can be applied in this case (but the bank should have suitable computational resources).
